...
public class Registro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //progressDialog = new ProgressDialog(Registro.this, R.style.AppCompatAlertDialogStyle);
        ...
        firebaseAuth.createUserWithEmailAndPassword(correo, password)
                .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Registro.this, "Error al crear cuenta: "
                                + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void GuarInformacion() {
        ...
        //databaseReference.child(uid).setPriority(Datos)
