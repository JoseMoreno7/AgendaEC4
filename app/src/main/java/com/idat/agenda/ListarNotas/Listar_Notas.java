package com.idat.agenda.ListarNotas;
...
//import com.redsytem.agenda.ViewHolder.ViewHolder_Nota;
//import com.redsytem.agenda.R;
import com.firebase.ui.database.FirebaseRecyclerOptions;
import com.idat.agenda.ViewHolder.ViewHolder_Nota;
...
public class Listar_Notas extends AppCompatActivity {
    ...
    private void ListarNotasUsurios(){
        options = new FirebaseRecyclerOptions.Builder<Nota>()
                .setQuery(BASE_DE_DATOS, Nota.class).build();
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Nota, ViewHolder_Nota>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolder_Nota viewHolder_nota,
                                            int position, @NonNull Nota nota) {
            ...
            public ViewHolder_Nota onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewHolder_nota.setOnClickListener(new ViewHolder_Nota.ClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Toast.makeText(Listar_Notas.this, "on item click",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onItemLongClick(View view, int position) {
                        //Toast.makeText(Listar_Notas.this, "on item long click",
                        //        Toast.LENGTH_SHORT).show();
                        // Declarar las vistas
                        ...
                        CD_Eliminar.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Toast.makeText(Listar_Notas.this,
                        ...
                        CD_Actualizar.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Toast.makeText(Listar_Notas.this,
                                        "Actualizar nota", Toast.LENGTH_SHORT).show();
                            }
                        });
        ...
        linearLayoutManager =new LinearLayoutManager(Listar_Notas.this,
